...
if (!function_exists('upload_files')) {
    function upload_files($name_post = '', $size_file = 1024, $overwrite = false, $allow = '*', $path_file = '')
    {
        ...
        $config['file_name']        = 'files_' . round(microtime(true) * 1000 + time());
...
if (!function_exists('upload_photo')) {
    function upload_photo($name_post = '', $size_file = 1024, $overwrite = false, $path_file = '', $width = 250, $height = 250, $thumb = TRUE, $new_path = '', $watermark = '')
    {
        $CI = &get_instance();
        ...
        if ($upload['respons']) {
            ...
            $image_info = getimagesize(FCPATH . $path_file . '/' . $file_name);
            ...
            if ($watermark != '') {
                ...
                $conf['new_image']          = FCPATH . $path_file;
                $conf['wm_text']            = $watermark;
                $conf['wm_type']            = 'text';
                $conf['wm_font_path']       = FCPATH . 'system/fonts/texb.ttf';
                $conf['wm_font_size']       = '12';
                $conf['wm_font_color']      = 'ffffff';
                // $conf['wm_shadow_color']    = '000';
...
if (!function_exists('kompres_photo')) {
    function kompres_photo($file_name = '', $path_file = '', $new_path = '', $thumb = FALSE, $width = 250, $height = 250)
    {
        $CI = &get_instance();
