                    ...
                    <div class="header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-lg-3" style="float: right;">
                                <button onclick="clear_data()" data-toggle="modal" data-target="#modal_add" class="btn bg-light-blue btn-block waves-effect" style="margin-bottom: -15px"><i class="material-icons" style="margin-bottom: 13px;">widgets</i> TAMBAH WMK</button>
                            </div>
                        </div>
                    </div>
                    <hr>
                                ...
                                <tbody>
                                    <?php $no=1; foreach ($wmk as $data) { ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            <td><?= $data->nama_wmk ?></td>
                                            <td><?= $data->nomor_wmk ?></td>
                                            <td><?= $data->alamat_wmk ?></td>
                                            
                                            <td>
                                                <button title="Edit" class="btn btn-sm cbtn-raised bg-green waves-effect" data-toggle="modal" data-target="#modal_edit" onclick="editWmk('<?= $data->id_wmk ?>','<?= $data->nama_wmk ?>','<?= $data->nomor_wmk ?>','<?= $data->alamat_wmk ?>')" style="margin-bottom: 5px;"><i class="material-icons" style="margin-bottom: 10px;">border_color</i></button>
                                                <button title="Hapus" class="btn btn-sm cbtn-raised btn-danger waves-effect" onclick="hapusNomor('<?= $data->id_wmk ?>')" style="margin-bottom: 5px;"><i class="material-icons" style="margin-bottom: 10px;">delete</i></button>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
...
<script type="text/javascript">
    ...
    function editWmk(id='', nama='', nomor='', alamat='') {
        // $.post("<?//= base_url() ?>/Damkar/showEditInfo", {id_wmk: id}, function(result){
