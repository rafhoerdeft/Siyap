    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="<?php //if ($id_nav==12) { echo 'active';}  ?>">
                    <a href="<?//= base_url()."Damkar/itemMobil" ?>">
                        <i class="material-icons" style="float: left;">extension</i>
                        <span style="float: left; margin-top: 5px; margin-left: 20px">Item Mobil Damkar</span>
                    </a>
                </li>
                <li class="<?php //if ($id_nav==13) { echo 'active';}  ?>">
                    <a href="<?//= base_url()."Damkar/alatDamkar" ?>">
                        <i class="material-icons" style="float: left;">build</i>
                        <span style="float: left; margin-top: 5px; margin-left: 20px">Alat Damkar</span>
                    </a>
                </li> -->
                ...
                <!-- <li class="<?php //if ($id_nav==9) { echo 'active';}  ?>">
                    <a href="<?//= base_url()."Damkar/nomorDarurat" ?>">
