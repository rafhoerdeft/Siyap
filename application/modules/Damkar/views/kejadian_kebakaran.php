                    ...
                    <div class="header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-lg-3" style="float: right;">
                                <a href="<?= base_url('Damkar/addKejadianKebakaran') ?>" class="btn btn-sm bg-light-blue btn-block waves-effect" style="margin-bottom: -15px"><i class="material-icons" style="margin-bottom: 13px;">note_add</i> Tambah Laporan</a>
                            </div>
                        </div>
                    </div>
                    <hr>
                            ...
                            <table id="data_kejadian" class="table table-bordered table-striped table-hover table-responsive">
                                ...
                                <!-- <tbody style="font-size: 8pt"> -->
                                    ...
                                    <!-- <tr> -->
                                        ...
                                        <!-- <td nowrap>
                                            <a href="<?//= base_url('Damkar/editKejadianKebakaran/'.encode($data->id_lapor)) ?>" 
                                            ...
                                            <button title="Hapus" class="btn btn-sm btn-danger waves-effect" onclick="delLap('<?//= $data->id_lapor ?>')" style="margin-bottom: 5px; width: 5px;"><i class="material-icons" style="font-size: 12pt; margin-top: -5px; margin-left: -5px;">delete</i></button>

                                            <a href="<?//= base_url('Damkar/cetakLap2/'.$data->id_lapor) ?>" target="_blank" title="Cetak Laporan" class="btn btn-sm bg-purple waves-effect"
                    ...
                    $.post("<?= base_url() ?>/Damkar/hapusLaporan", {id_lapor: id}, function(result){
                      // alert(result);
                        if (result == 'Success') {
                            ...
                            window.location.href = "<?= base_url().'Damkar/kejadianKebakaran/' ?>";
                        }else{
                            swal("Gagal!");
                        }
                    });
