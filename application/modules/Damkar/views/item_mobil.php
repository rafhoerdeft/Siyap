                                ...
                                <tbody>
                                    <?php $no=1; foreach ($item_mobil as $data) { ?>
                                        <tr>
                                            ...
                                            <td nowrap>
                                                <button title="Edit" class="btn btn-raised bg-green waves-effect" onclick="editModal('<?= $data->id_mobil_item ?>','<?= $data->id_item ?>','<?= $data->jml_item ?>')" style="margin-bottom: 5px;">
...
<script type="text/javascript">
    ...
    function editModal(id='', item='', jml='') {
        clear_data();
