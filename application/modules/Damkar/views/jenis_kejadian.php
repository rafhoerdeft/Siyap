                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="data-info">
                                <thead>
                                    <tr>
                                        <th width="5%">#</th>
                                        <th width="50%">Nama Jenis Kejadian</th>
                                ...
                                <tbody>
                                    <?php $no=1; foreach ($kejadian as $data) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button title="Edit" class="btn btn-sm cbtn-raised bg-green waves-effect" data-toggle="modal" data-target="#modal_edit" onclick="editKejadian('<?= $data->id_jenis_lap ?>','<?= $data->nama_jenis_lap ?>','<?= $data->grup_jenis ?>')" style="margin-bottom: 5px;"><i class="material-icons" style="margin-bottom: 10px;">border_color</i></button>
...
<script type="text/javascript">
    ...
    function editKejadian(id='', jenis='', grup='') {
        // $.post("<?//= base_url() ?>/Damkar/showEditPesan", {id_jenis_lap: id}, function(result){
