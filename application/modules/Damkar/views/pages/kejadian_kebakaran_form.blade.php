            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?= show_alert() ?>
                            <form name="laporan" id="lp" method="post" action="<?= base_url().'Damkar/'.($form == 'add'?'simpanKejadianKebakaran':'updateKejadianKebakaran'); ?>" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label">Obyek Terbakar</label>
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="obyek_terbakar"
                                                        id="obyek_terbakar" value="<?= (isset($laporan['obyek_terbakar']) ? $laporan['obyek_terbakar'] : '') ?>" required>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label">Asal Api</label>
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="asal_api" id="asal_api" value="<?= (isset($laporan['asal_api']) ? $laporan['asal_api'] : '') ?>"
                                                        required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="nama_pemilik"
                                                        id="nama_pemilik" value="<?= (isset($laporan['nama_korban']) ? $laporan['nama_korban'] : '') ?>" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-line">
                                                    <textarea rows="1" class="form-control no-resize auto-growth"
                                                        name="ket_kejadian" id="ket_kejadian" required><?= (isset($laporan['ket_laporan']) ? $laporan['ket_laporan'] : '') ?></textarea>
                                                </div>
                                            </div>
                                ...
                                <div class="modal-footer">
                                    <a href="<?= base_url('Damkar/kejadianKebakaran') ?>" type="button"
