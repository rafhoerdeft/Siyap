                            ...
                            <table id="data_histori" class="table table-bordered table-striped table-hover table-responsive">
                                ...
                                <!-- <tbody style="font-size: 8pt">
                                    <?php //$no=1; foreach ($histori as $data) { ?>
                                        <tr>
                                            <td><?php //echo $data->id_lapor ?></td>
                                            <td nowrap>
                                                <?php //if ($data->status == 'selesai' || $data->status == 'batal') { 
                                                        //if ($data->status == 'batal') {
                                                ?>
                                                            <button title="Laporan Kejadian Lain-Lain" class="btn btn-sm bg-link waves-effect" style="margin-bottom: 5px; width: 5px;" disabled><i class="material-icons" style="font-size: 12pt; margin-top: -5px; margin-left: -5px;">assignment</i></button>
                                                    ...
                                                    <?php //}else{ ?>
                                                            <button title="Laporan Kejadian Lain-Lain" class="btn btn-sm bg-green waves-effect" onclick="addLap('<?php //echo $data->id_lapor ?>', '<?php //echo $data->nama_user ?>')" style="margin-bottom: 5px; width: 5px;"><i class="material-icons" style="font-size: 12pt; margin-top: -5px; margin-left: -5px;">assignment</i></button>

                                                            <button title="Laporan Kebakaran" class="btn btn-sm bg-pink waves-effect" onclick="addLapKebakaran('<?php //echo $data->id_lapor ?>', '<?php //echo $data->nama_user ?>')" style="margin-bottom: 5px; width: 5px;"><i class="material-icons" style="font-size: 12pt; margin-top: -5px; margin-left: -5px;">assignment</i></button>
                                                    <?php //} ?>
                                                    <br>
                                                        <button title="Selesai" class="btn btn-sm bg-link waves-effect" disabled style="margin-bottom: 5px; width: 5px;"><i class="material-icons" style="font-size: 12pt; margin-top: -5px; margin-left: -5px;">check_circle</i></button>

                                                        <button title="Batal" class="btn btn-sm bg-link waves-effect" disabled style="margin-bottom: 5px; width: 5px;"><i class="material-icons" style="font-size: 12pt; margin-top: -5px; margin-left: -5px;">cancel</i></button>
                                                <?php //}else{ ?>
                                                        <button title="Laporan Kejadian Lain-Lain" class="btn btn-sm bg-link waves-effect" style="margin-bottom: 5px; width: 5px;" disabled><i class="material-icons" style="font-size: 12pt; margin-top: -5px; margin-left: -5px;">assignment</i></button>

                                                        <button title="Laporan Kebakaran" class="btn btn-sm bg-link waves-effect" style="margin-bottom: 5px; width: 5px;" disabled><i class="material-icons" style="font-size: 12pt; margin-top: -5px; margin-left: -5px;">assignment</i></button>
                                                        <br>
                                                        <button title="Selesai" class="btn btn-sm bg-orange waves-effect" style="margin-bottom: 5px; width: 5px;" onclick="lapSelesai('<?php //echo $data->id_lapor ?>')"><i class="material-icons" style="font-size: 12pt; margin-top: -5px; margin-left: -5px;">check_circle</i></button>

                                                        <?php //if ($data->status == 'proses') { ?>
                                                            <button title="Batal" class="btn btn-sm bg-link waves-effect" disabled style="margin-bottom: 5px; width: 5px;"><i class="material-icons" style="font-size: 12pt; margin-top: -5px; margin-left: -5px;">cancel</i></button>
                                                        <?php //}else{ ?>
                                                        <button title="Batal" class="btn btn-sm bg-red waves-effect" style="margin-bottom: 5px; width: 5px;" data-toggle="modal" data-target="#modal_batal" onclick="lapBatal('<?php //echo $data->id_lapor ?>')"><i class="material-icons" style="font-size: 12pt; margin-top: -5px; margin-left: -5px;">cancel</i></button>
                                                <?php //}} ?>
                                            </td>
                                            <td><?php //echo $data->nama_user ?></td>
                                            <td><?php //echo $data->alamat ?></td>
                                            <td><?php //echo $data->keterangan ?></td>
                                            <td><?php //echo $data->nama_jenis_lap ?></td>
                                            <td><?php //echo date('d-m-Y (H:i)', strtotime($data->tgl_lapor)) ?></td>
                                            <td>
                                                <?php //if($data->image_lapor != null && $data->image_lapor != ''){  ?>
                                                        <a class="foto_kejadian" href="<?php //echo base_url().'assets/path_laporan/'.$data->image_lapor ?>" rel="<?php //echo $data->id_lapor ?>"><button class="btn btn-sm btn-primary waves-effect" style="width: 65px; margin-bottom: 5px;">Kejadian</button></a><br>
                                                <?php //} if($data->image_selfie != null && $data->image_selfie != ''){  ?>
                                                        <a class="foto_kejadian" href="<?php //echo base_url().'assets/path_selfie/'.$data->image_selfie ?>" rel="<?php //echo $data->id_lapor ?>"><button class="btn btn-sm bg-pink waves-effect" style="width: 65px">Pelapor</button></a>
                                                <?php //} ?>
                                            </td>
