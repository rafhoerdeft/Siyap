        ...
        <div class="modal-content">
            <div class="row">
                ...
                <div class="col-sm-10 col-md-10 col-lg-10">
                    <form name="simpanRole" id="simpanRole" method="post" action="<?= base_url().'Admin/simpanNomor'; ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="row">
                <div class="col-md-1 col-sm-1 col-lg-1"></div>
                <div class="col-sm-10 col-md-10 col-lg-10">
                    <form name="simpanRole" id="simpanRole" method="post" action="<?= base_url().'Admin/UpdateNomor'; ?>">
                        <input type="hidden" name="id_nomor_darurat" id="id_nomor_darurat">
                        <div class="modal-header">
                            <center>
...
<script type="text/javascript">
    ...
    function editNomor(id='', kategori='', nomor='', alamat='') {
        // $.post("<?//= base_url() ?>/Admin/showEditInfo", {id_nomor_darurat: id}, function(result){
        ...
        swal({
          ...
          showLoaderOnConfirm: true,
            ...
            setTimeout(function () {
                    ...
                    $.post("<?= base_url() ?>/Admin/hapusNomor", {id_nomor_darurat: id}, function(result){
                      // alert(result);
                        if (result == 'Success') {
                            swal("Data berhasil dihapus!");  
                            window.location.href = "<?= base_url().'Admin/nomorDarurat/' ?>";
                        }else{
                            swal("Gagal!");
                        }
                    });
