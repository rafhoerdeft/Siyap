    ...
    <script type="text/javascript">
        ...
        function showConfirmMessage(id) {
            swal({
                ...
                $.ajax({
                    type : "GET",
                    url  : "<?php echo base_url('Sampah/deleteUnit')?>",
                    dataType : "html",
                    data : {id:id},
...
<!--     <script type="text/javascript">
        function delPendidik(id_log, id_pend) {
            ...
            swal({
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('Sampah/deletePend')?>",
                    dataType : "html",
                    ...
                    success: function(data){
                        ...
                        if(data=='Success'){
                            showSuccessMessage('Dihapus');
                            setTimeout(function(){location='<?= base_url('Sampah/dataLoginPendidik')?>'},700);
                        }else{
                            showFailedMessage('Dihapus');
                        } 
                    }
    ...
    <script type="text/javascript">
        ...
        $('#Modal_Ubah_Pwd #btn_simpan').on('click',function(){
            ...
            if (oldPass=='' || newPass=='' || newPass2=='') {
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('Sampah/changePassword')?>",
                    dataType : "html",
        ...
        function validPass(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('index.php/Sampah/validPassword')?>",
                dataType : "html",
