    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="row">
                ...
                <div class="col-md-10">
                    <form name="laporan" id="lp" method="post" action="<?= base_url().'Sampah/simpanLap'; ?>">
      ...
      swal({
          ...
          showLoaderOnConfirm: true,
            ...
            setTimeout(function () {
                    ...
                    $.post("<?= base_url() ?>/Sampah/lapSelesai", {id_lap: id, key: key}, function(result){
                      // alert(result);
                        if (result == 'Success') {

                          // var remove = firebase.database().ref('Sampah/'+key).remove();
                            var removes = 0;
                            var ref = firebase.database().ref().child('/Sampah');
...
<script type="text/javascript">
    ...
    function addLap(id, pelapor) {
        $.post("<?= base_url() ?>/Sampah/showLap", {id_lap: id}, function(result){
            ...
            $('#btn_cetak').attr("href","<?= base_url().'Sampah/cetakLap/' ?>"+id);
        });
...
<script type="text/javascript">
    function printLaporan(n){
        ...
        window.location.href = "<?=base_url().'Sampah/historiAduan' ?>";
    }
</script>
