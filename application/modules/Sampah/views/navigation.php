...
<nav class="navbar">
    <div class="col-12">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Sampah</a>
        </div>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            <div class="image">
                ...
                ?>
                <img src="<?php echo base_url().'assets/';?>assets/images/icon-profil/<?=$first?>.jpg" width="48" height="48" alt="User" />
            </div>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <!-- <li class="<?php //if ($id_nav==1) { echo 'active';}  ?>">
                    <a href="<?//= base_url()."Sampah/index" ?>">
                        <i class="material-icons" style="float: left;">home</i>
                        <span style="float: left; margin-top: 5px; margin-left: 20px">Beranda</span>
                    </a>
                </li> -->
                ...
                <li class="<?php if ($id_nav==3) { echo 'active';}  ?>">
                    <a href="<?= base_url()."Sampah/historiAduan" ?>">
                ...
                <!-- <li class="<?php //if ($id_nav==3) { echo 'active';}  ?>">
                    <a href="<?//= base_url()."Sampah/dataLoginAnak" ?>">
