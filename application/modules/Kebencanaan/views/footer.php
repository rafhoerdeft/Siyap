...
<!--     <script type="text/javascript">
        function delPendidik(id_log, id_pend) {
            ...
            swal({
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('Kebencanaan/deletePend')?>",
                    dataType : "html",
                    ...
                    success: function(data){
                        ...
                        if(data=='Success'){
                            showSuccessMessage('Dihapus');
                            setTimeout(function(){location='<?= base_url('Kebencanaan/dataLoginPendidik')?>'},700);
                        }else{
                            showFailedMessage('Dihapus');
                        } 
                    }
    ...
    <script type="text/javascript">
        ...
        $('#Modal_Ubah_Pwd #btn_simpan').on('click',function(){
            ...
            if (oldPass=='' || newPass=='' || newPass2=='') {
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('Kebencanaan/changePassword')?>",
                    dataType : "html",
        ...
        function validPass(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('index.php/Kebencanaan/validPassword')?>",
                dataType : "html",
