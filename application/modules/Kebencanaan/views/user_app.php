        ...
        <div class="modal-content">
            <div class="row">
                ...
                <div class="col-sm-10 col-md-10 col-lg-10">
                    <form name="laporan" id="lp" method="post" action="<?= base_url().'Kebencanaan/simpanUser'; ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="row">
                <div class="col-md-1 col-sm-1 col-lg-1"></div>
                <div class="col-sm-10 col-md-10 col-lg-10">
                    <form name="laporan" id="lp" method="post" action="<?= base_url().'Kebencanaan/updateUser'; ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div style="margin-top: -17px">
                                           <select class="form-control show-tick" name="role_user" id="role_user" required>
                                               <?php foreach ($role as $key) { ?>
                                                        <option class="role_user" value="<?= $key->id_role ?>" id="<?= str_replace(' ', '_', $key->role) ?>"><?= $key->role ?></option>
                                               <?php } ?>
                                           </select>
                                        </div>
                                       <!-- </div> -->
        ...
        swal({
          ...
          showLoaderOnConfirm: true,
            ...
            setTimeout(function () {
                    ...
                    $.post("<?= base_url() ?>/Kebencanaan/hapusUser", {id_user: id}, function(result){
                      // alert(result);
                        if (result == 'Success') {
                            swal("Data berhasil dihapus!");  
                            window.location.href = "<?= base_url().'Kebencanaan/userApp/' ?>";
                        }else{
                            swal("Gagal!");
                        }
                    });
