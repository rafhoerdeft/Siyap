        ...
        <div class="modal-content">
            <div class="row">
                ...
                <div class="col-sm-10 col-md-10 col-lg-10">
                    <form name="simpanRole" id="simpanRole" method="post" action="<?= base_url().'Kebencanaan/simpanNomor'; ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="row">
                <div class="col-md-1 col-sm-1 col-lg-1"></div>
                <div class="col-sm-10 col-md-10 col-lg-10">
                    <form name="simpanRole" id="simpanRole" method="post" action="<?= base_url().'Kebencanaan/updateNomor'; ?>">
                        <input type="hidden" name="id_no_telp" id="id_no_telp">
                        <div class="modal-header">
                            <center>
...
<script type="text/javascript">
    ...
    function editNomor(id='', kontak='', nomor='') {
        // $.post("<?//= base_url() ?>/Kebencanaan/showEditInfo", {id_no_telp: id}, function(result){
        ...
        swal({
          ...
          showLoaderOnConfirm: true,
            ...
            setTimeout(function () {
                    ...
                    $.post("<?= base_url() ?>/Kebencanaan/hapusNomor", {id_no_telp: id}, function(result){
                      // alert(result);
                        if (result == 'Success') {
                            swal("Data berhasil dihapus!");  
                            window.location.href = "<?= base_url().'Kebencanaan/nomorTelp/' ?>";
                        }else{
                            swal("Gagal!");
                        }
                    });
