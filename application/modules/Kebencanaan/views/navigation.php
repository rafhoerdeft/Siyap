...
<nav class="navbar">
    <div class="col-12">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Kebencanaan</a>
        </div>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="<?php if ($id_nav==1) { echo 'active';}  ?>">
                    <a href="<?= base_url()."Kebencanaan/index" ?>">
                ...
                <li class="<?php if ($id_nav==2) { echo 'active';}  ?>">
                    <a href="<?= base_url()."Kebencanaan/trackLaporan" ?>">
                ...
                <li class="<?php if ($id_nav==3) { echo 'active';}  ?>">
                    <a href="<?= base_url()."Kebencanaan/historiAduan" ?>">
                ...
                <li class="<?php if ($id_nav==4) { echo 'active';}  ?>">
                    <a href="<?= base_url()."Kebencanaan/userApp" ?>">
                ...
                <li class="<?php if ($id_nav==5) { echo 'active';}  ?>">
                    <a href="<?= base_url()."Kebencanaan/nomorTelp" ?>">
                ...
                <li class="<?php if ($id_nav==6) { echo 'active';}  ?>">
                    <a href="<?= base_url()."Kebencanaan/pesan" ?>">
                ...
                <li class="<?php if ($id_nav==7) { echo 'active';}  ?>">
                    <a href="<?= base_url()."Kebencanaan/jenisKejadian" ?>">
                ...
                <li class="<?php if ($id_nav==8) { echo 'active';}  ?>">
                    <a href="<?= base_url()."Kebencanaan/awalNotif" ?>">
                ...
                <li class="<?php if ($id_nav==9) { echo 'active';}  ?>">
                    <a href="<?= base_url()."Kebencanaan/nomorDarurat" ?>">
                ...
                <li class="<?php if ($id_nav==10) { echo 'active';}  ?>">
                    <a href="<?= base_url()."Kebencanaan/batasJarak" ?>">
                ...
                <li class="header">
                    &copy; 2019 Create By - DISKOMINFO <br>
                    <b>Version: </b> 1.8.1
                </li>
            </ul>
        </div>
