    ...
    function add_map_point(data) {
      ...
      if (data.val().role == 'User') {
        ...
        var contents = '<div id="pop">'+
                         ...
                         // "<a class='fotoxxx' href=<?//= base_url().'assets/path_laporan/' ?>"+img_kejadian+" rel='saksake'> <img class='img-fluid img-thumbnail' height='150' src=<?//= base_url().'assets/path_laporan/' ?>"+img_kejadian+" alt=''> </a>"+
                         "<a class='fotoxxx' href=<?= base_url().'assets/path_laporan/' ?>"+img_kejadian+" rel='kejadian'> <button onclick='fancys()' class='btn btn-block bg-green waves-effect'>FOTO KEJADIAN</button> </a>"+
                         "<a class='fotoxxx' href=<?= base_url().'assets/path_selfie/' ?>"+img_selfie+" rel='selfie'> <button style='margin-bottom:10px' onclick='fancys()' class='btn btn-block bg-pink waves-effect'>FOTO PELAPOR</button> </a>"+
                         // "</div>"+
                         "</center></p>"+
                        '</div>';
